...
public class BaseThread extends Thread
{
	 ...
	 * Keeps track of the next available unique thread ID
	 * Each time a new BaseThread is created, this value is incremented and assigned to the thread's iTID attribute.
	 */
	public static int siNextTID = 1;

	/**
	 * This is the unique thread ID for an instance of BaseThread.
	 * It is assigned a value from siNextTID when the thread is created
	 */
	protected int iTID;
